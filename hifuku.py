...
def main(root, path, is_wsi, scale):
    ...
    fiber_det_weights_path = f'{root}/weights/mobilenet_20220704_20:51:34_epoch30_n_aug16_batch16_0958.pt'
    myelin_seg_weights_path = f'{root}/weights/Deeplab_20220608_05:58:10_n_559_epoch200_batch16_no_aug_classes_3_mIoU_0.817.pt'
...
def detect_fiber(splitted_fascicle, weights_path, margin, threshold=0.5, crop_size=200, delta=2):
    ...
    for n, img in enumerate(splitted_fascicle):
        ...
        for i, box in enumerate(y['boxes']):
            ...
            # exclude boxes whose center is outside the margin
